        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Companies_Companies_ParentId1",
                        column: x => x.ParentId1,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Orders_Orders_ParentId1",
                        column: x => x.ParentId1,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Pokemon_Pokemon_ParentId1",
                        column: x => x.ParentId1,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Companies_ParentId1",
                table: "Companies",
                column: "ParentId1");

            migrationBuilder.CreateIndex(
                name: "IX_Orders_ParentId1",
                table: "Orders",
                column: "ParentId1");

            migrationBuilder.CreateIndex(
                name: "IX_Pokemon_ParentId1",
                table: "Pokemon",
                column: "ParentId1");
